...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: `https://www.eightharsh.com/og/blog?title=${post.metadata.title}`,
        },
      ],
    },
    twitter: {
      ...
      creator: "@eightharsh",
      images: [
        `https://www.eightharsh/og/blog?title=${post.metadata.title}&top=${publishedTime}`,
      ],
    },
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: post.metadata.description,
            image: `https://eightharsh.com/og/blog?title=${
              post.metadata.title
